...
import com.example.myecosysgrad.dto.admin.request.AuthenticationRequest;
import com.example.myecosysgrad.dto.admin.request.IntrospectRequest;
import com.example.myecosysgrad.dto.admin.request.LogoutRequest;
import com.example.myecosysgrad.dto.admin.request.RefreshRequest;
import com.example.myecosysgrad.dto.admin.response.AuthenticationResponse;
import com.example.myecosysgrad.dto.admin.response.IntrospectResponse;
...
import com.example.myecosysgrad.repository.InvalidatedTokenRepo;
...
public class AuthenticationService {
    ...
    public AuthenticationResponse refreshToken(RefreshRequest request) throws JOSEException, ParseException {
        ...
        InvalidatedToken invalidatedToken =
                InvalidatedToken.builder().id(jti).expirationTime(expiryTime).build();
        invalidatedTokenRepo.save(invalidatedToken);
